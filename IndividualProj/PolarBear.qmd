...
sd = (gl_upper - gl_lower) / qnorm(0.975) / 2
gl = rnorm(1000, gl_mean, sd)
```
...
> Modification: You are to consider resent projections on the Last Ice Area.
> 
> [Last Ice Area](https://www.arcticwwf.org/our-priorities/last-ice-area/)

`ice`: reduced-ice days(days/year)
...
The linear model for Approach 2 included an intercept for each subpopulation and a single, global 
slope coefficient：
